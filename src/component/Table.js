    ...
    {data && data.map((v, i) => {
      return(
        <tr key={i}>
          ...
          <td>{v.email}</td>
          <td>{v.phone}</td>
          <td type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => updateData(v)}>Edit</td>
  ...
  <div className="modal-dialog">
    ...
    <form className="modal-form">
        ...
        <div className="mb-3">
          ...
          <input onChange={onChange} name="contact" value={userData.phone} type="text" className="form-control"/>
        </div>
